...
- **Self-improvement**: the "Improve Galatea" button opens a session on Galatea's own source code, with her architecture and style rules in the prompt. Ask the model to change her UI and it edits the app you are using. The statue sculpts herself.
...
- **Automiglioramento**: il bottone "Improve Galatea" apre una sessione sul codice sorgente di Galatea stessa, con architettura e regole di stile nel prompt. Chiedi al modello di cambiarle l'interfaccia e lui modifica l'app che stai usando. La statua si scolpisce da sola.
